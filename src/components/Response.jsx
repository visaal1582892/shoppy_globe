...
const Response = () => {
  ...
  return (
    <section className={`${status=="ideal"?"hidden":"animate-revealing"} flex fixed top-[20vh] right-0 w-[80%] sm:w-sm h-20 ${status=="success"?"bg-green-500":"bg-red-600"} text-white text-lg p-2 rounded-md m-1 z-60`}>
        {msg}
